        ...
        */
        ...
        if (scene == 10) {
            ...
            if (rulesvisible == 2) { // FAQ here
                ...
                DrawText("manti09_isnt_available", 10.0f, (520.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("orstando", 10.0f, (530.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("pie_300", 10.0f, (540.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("sertarulcelmagic", 10.0f, (550.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("themisterbread", 10.0f, (560.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("virtualleee", 10.0f, (570.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("virxti", 10.0f, (580.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("wildfire0196", 10.0f, (590.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                //wrap here
                ...
                DrawText("manti", 170.0f, (430.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("orstando", 170.0f, (440.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                ...
                //and resume here
                DrawText("Note: most users appear on both lists,", 20.0f, (600.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("but they're not lined up properly here.", 20.0f, (610.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("Can I make my own theme?", 10.0f, (640.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("Of course! at/ei_tii handles custom theme", 20.0f, (650.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("requests (and I'm online frequently!). A", 20.0f, (660.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("survey has been provided for you to", 20.0f, (670.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("submit original themes:", 20.0f, (680.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("https://forms.gle/XYoKe2NgHM1QH5y98", 20.0f, (690.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("Why did I get banned?", 10.0f, (720.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("We try and clearly communicate with users", 20.0f, (730.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("when they're breaking our rules. If we", 20.0f, (740.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("have repeatedly asked you to stop, you", 20.0f, (750.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("will be banned, and we DO NOT accept ban", 20.0f, (760.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("appeals. Reentering chat to ask this", 20.0f, (770.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("question will result in a short response", 20.0f, (780.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("and another ban.", 20.0f, (790.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("Are you going to add...", 10.0f, (820.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("Below is a non-exhaustive list of features", 20.0f, (830.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("we plan to add to Aurorachat. Our team is", 20.0f, (840.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("rather small--please be patient with us!", 20.0f, (850.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("- Several rooms/servers to chat in, as", 20.0f, (860.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("well as DMs", 20.0f, (870.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("- Image support", 20.0f, (880.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("- Voice chat support", 20.0f, (890.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("- BGM and sound effects", 20.0f, (900.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("- Moderation improvement (kicking, ban", 20.0f, (910.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("messages, timeoutting, public moder-", 20.0f, (920.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                DrawText("ation, automatic unbans, \"admin swag\")", 20.0f, (930.0f + rulescroll), 0, 0.5f, 0.5f, textcolorb, true);
                C2D_DrawRectSolid(0.0f, 0.0f, 0, 320.0f, 30.0f, themecolor);
                DrawText(": Next Page | , : Scroll Rules", 10.0f, 10.0f, 0, 0.5f, 0.5f, textcolor, true);
            }
